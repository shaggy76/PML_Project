...
This is the training data pull.  I've reduced the size of the training set to improve running time.  The full set takes a longer time to execute, but ulitimately, that will give better prediction results.
...
After building the model, the results were not great with a little over 53% accuracy.  This model was not acceptable and it was hard to find other ways to improve the model.
